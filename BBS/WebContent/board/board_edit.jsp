...
<div class="container">
	...
	<table border="1" width="100%">
		...
		<tr>
			...
			<td colspan="3">
				<input name="subject" id="subject" class="form-control" value="${dto.subject}">
			</td>
		</tr>
		<tr>
			<td align="center">이름</td>
			<td colspan="3">
				<input name="writer" id="writer" class="form-control" value="${dto.writer}" readonly>
			</td>
		</tr>
		<tr>
			<td align="center">본문</td>
			<td colspan="3">
				<textarea name="content" id="content" class="form-control" AUTOFOCUS>${dto.content}</textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="3">
				<c:if test="${dto.filesize > 0}">
					${dto.filename}
					(${dto.filesize} bytes)
					<input type="checkbox" name="fileDel" class="form-control"> 첨부파일 삭제
				</c:if>
